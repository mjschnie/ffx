    ...
    public static Collection<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                ...
                },
                {
                        ...
                        ThermoTestMode.FREE, -8.5, 1.0, null, null, null, null, null, null,
                        new String[]{"-C", "10", "--s1", "1", "--f1", "9", "-d", "1.0", "-n", "20000", "-w", "5", "--bM", "0.25", "--tp", "2"},
                ...
                },
                {
                        ...
                        new double[]{-19.59228442950045, Double.NaN}, new double[]{-9.190076958067609, Double.NaN},
                        new double[]{-0.41127233350298553, Double.NaN},
                        new double[][][]{
                                {{-0.8544588637862072, -0.8397341056649319, 0.06944048731983576},
                        ...
                        new double[][][]{
                                ...
                                new double[2][3]},
                        new String[]{"-l", "0.9", "--s1", "1", "--f1", "9"}, new String[]{}, new String[]{}
                },
                {
                        ...
                        new double[][][]{
                                ...
                                new double[2][3]},
                        new String[]{"-l", "1.0", "--s1", "1", "--f1", "9"}, new String[]{}, new String[]{}
                },
                {
